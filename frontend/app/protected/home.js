...
export default function HomeScreen() {
  ...
  const resources = [
    { title: "Self Defense", image: require("../../assets/images/self-defense.jpg"), url: "https://www.youtube.com/watch?v=KVpxP3ZZtAc" },
  ...
  const openCallHistory = () => Linking.openURL("tel:*#07#");
  const openMessageHistory = () => Linking.openURL("sms:");
  const openAlertHistory = () => alert("Opening Alert History...");
    ...
    <LinearGradient colors={["#fff", "#fc73c0"]} style={{ flex: 1, padding: 20 }}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={{ flexDirection: "row", backgroundColor: "#fff", padding: 10, borderRadius: 50, marginBottom: 10 }}>
          ...
          <TextInput placeholder="Search for resources, news, etc" style={{ flex: 1, marginLeft: 10 }} />
        </View>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 10 }}>
          ...
          <View style={settingBox}>
            ...
            <Switch value={isButtonConnected} onValueChange={handleBluetoothToggle} />
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginTop: 10 }}>
          ...
          <TouchableOpacity style={buttonStyle} onPress={() => router.push("/protected/emergency")}>
            <Text>Look for Safe Spots</Text>
          </TouchableOpacity>
