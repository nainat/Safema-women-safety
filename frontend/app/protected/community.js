...
const ALL_COMMUNITIES = [
  {
    id: '1',
    name: 'Miyapur Neighborhood Watch',
    members: 323,
    ...
    messages: [
      { id: '1', user: 'Rusheeka', message: 'Hey everyone! Just wanted to report that the street lights on Oak Avenue are working again.', time: '10:30 AM' },
